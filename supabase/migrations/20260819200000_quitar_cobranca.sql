...
/**
 * Marca a cobrança como paga e devolve a linha.
 *
 * IDEMPOTENTE, e isso não é zelo: todo gateway reenvia o postback quando não
 * recebe 200 rápido o bastante. Sem a saída antecipada, o segundo aviso
 * recalcularia o vencimento — e desta vez a própria cobrança já estaria paga e
 * válida, somando outros trinta dias em cima. O cliente ganharia dois meses
 * por um erro de rede.
 */
