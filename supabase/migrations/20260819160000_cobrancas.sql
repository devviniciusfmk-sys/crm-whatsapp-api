-- As cobranças da loja para os clientes dela.
--
-- Ver `03_models/03-20_cobrancas.sql` para o porquê de existirem separadas
-- de `billing.invoices`: são dois dinheiros com dois donos.
