...
-- - 2026/08/22
create or replace function public.iptv_token_secret_name(p_servidor_id uuid)
returns text
language sql
immutable
set search_path to ''
...
create or replace function public.get_iptv_token(p_servidor_id uuid)
returns text
language sql
stable
security definer
...
create or replace function public.has_iptv_token(p_servidor_id uuid)
returns boolean
language sql
stable
security definer
...
create or replace function public.set_iptv_token(
  p_servidor_id uuid,
  p_token text
)
returns void
