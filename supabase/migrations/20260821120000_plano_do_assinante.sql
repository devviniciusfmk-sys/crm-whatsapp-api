-- Qual plano o assinante tinha, para a renovação já nascer preenchida.
--
-- Escolher à mão o mesmo plano toda vez é cobrar um clique por uma decisão que
-- já está tomada — e é justamente o clique em que se manda o plano errado,
-- porque ninguém lê com atenção um catálogo cujo item já se sabe de cor.
--
-- Duas colunas no FIM, que é o que `create or replace view` aceita sem 42P16.
